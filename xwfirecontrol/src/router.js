...
import FireControlApp from './XWFireControl/00_Containers/fireControlApp';
import NotFound from './XWFireControl/containers/NotFound/NotFound';
import login1  from'./XWFireControl/01_Login/Login/login';
import ProjectsPage from './XWFireControl/08_Projects/projects'
import register  from'./XWFireControl/01_Login/Register/register';
 import  bord  from './components/Dashboard/Dashboard1';
...
const Routers = function ({ history, app }) {
  const routes = [
    ...
    {
      path: '/login1',
      component:()=> import('./XWFireControl/01_Login/Login/login1')
    ...
    // {
    //   path: '/projectcheck',
    //   component: () => import('./08_Projects/projectcheck'),
    // },
    {
      path: '/dashboard2',
...
<Switch>
  ...
  <Route path="/" component={login1}/>
        ...
        {/*<Switch>*/}
          {/*<Route exact path="/" render={() => (<Redirect to="/login1"/>)} />*/}
          {/*{*/}
