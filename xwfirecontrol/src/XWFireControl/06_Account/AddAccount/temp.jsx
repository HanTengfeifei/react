...
class BaseFormDemo extends React.Component {
  ...
  {
    console.log("1wo d log"+ nextProps+ " "+ nextState);
  }
  componentDidUpdate( prevProps,  prevState)
  {
    console.log("2wo d log"+ prevProps+ " "+ prevState);
    }
  ...
  componentWillReceiveProps( nextProps) {
    console.log("3wo d log"+nextProps);
  }
  shouldComponentUpdate( nextProps,  nextState) {
    console.log("4wo d log"+ nextProps+ " "+ nextState);
  }
  ...
  render() {
    ...
    return (
      <div>
        ...
        <Row gutter={8} style={{ marginTop: '80px' }}>
          <Col span={24}>
